...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug  8 10:15:34 2021
...
def run_lstm_net(pd,st,me):
    ...
    with tf.Graph().as_default():
        ...
        with open('./model/lstm_net23000.pb',"rb") as f:
        ...
        with tf.Session(config=config) as sess:
            ...
            state=sess.graph.get_tensor_by_name("output_state:0")
            memory=sess.graph.get_tensor_by_name("output_memory:0")
...
def run_lstm_res(pd):
    ...
    with tf.Graph().as_default():
        ...
        with open('./model/lstm_res23000.pb',"rb") as f:
            output_graph_def.ParseFromString(f.read())
            _ =tf.import_graph_def(output_graph_def,name='')
        ...
        with tf.Session(config=config) as sess:
            ...
            res=sess.graph.get_tensor_by_name("output_res:0")
